...
subproceso registrar
	...
	Mientras opc =="si"  o  opc == "Si" Hacer 
		...
		FinSi
		escribir "Desea continuar con otro registro: ingrese si, x para salir";
		leer opc;
		si opc =="x"  o  opc == "X" Entonces
			Escribir  "regiatro agregado con éxito";
		FinSi
...
SubProceso inscrito
	...
	Definir curso1, curso2  Como logico;
...
SubProceso  verificar
	...
	Definir usuario1, usuario2, usuario Como Caracter;
	Definir curso1, curso2  Como logico;
